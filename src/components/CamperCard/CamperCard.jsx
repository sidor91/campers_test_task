...
export const CamperCard = ({ data }) => {
	...
	const isFavorite = useSelector(selectIsFavorite(data.id));
			...
			<div className={styles.content}>
				<div className={styles.header}>
					...
					<div className={styles.priceWrapper}>
						...
						<button className={styles.favoriteBtn} type="button" onClick={handleFavoriteClick}>
							<Icon
								iconName={DefaultIconsNamesMap.heart}
								width={24}
								height={20.5}
